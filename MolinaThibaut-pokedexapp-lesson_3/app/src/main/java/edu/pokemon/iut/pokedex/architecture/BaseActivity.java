...
public class BaseActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        search.setOnQueryTextListener(new SearchView.OnQueryTextListener(){
            ...
            public boolean onQueryTextSubmit(String s) {
                lastQuery=s;
                navigationManager.startPokemonList( null,lastQuery );
                return true;
            }
    ...
    public void onSaveInstanceState(Bundle out){
        out.putCharSequence( KEY_SEARCH,lastQuery );
        Log.d("bundle",lastQuery);
    ...
    public void onRestoreInstanceState(Bundle save){
        ...
        if(save!=null){
            lastQuery= (String)save.getCharSequence( KEY_SEARCH );
        }
    }
